...
public class CustomCardCredit extends Card  {
	String[] listData1;
	...
	public CustomCardCredit(Context context,String[] listData1, int i) {
	...
	public CustomCardCredit(Context context, int innerLayout) {
	...
	private void init(){
		...
		setOnClickListener(new OnCardClickListener() {
			...
			public void onClick(Card card, View view) {
				...
				switch (i) {
				case 1:
					context.startActivity(new Intent(Intent.ACTION_VIEW,Uri.parse("https://www.youtube.com/watch?v=M3aJ-cf73zo")).setFlags(Intent.FLAG_ACTIVITY_NEW_TASK));
					break;
				}
			}
		});
